...
**Answer: B** | **Explanation:** stop_reason is the definitive, programmatic signal. Parsing natural language is unreliable. Arbitrary caps are safety mechanisms only.

**Answer: B** | **Explanation:** `stop_reason` is the definitive, programmatic signal. Parsing natural language (A) is unreliable. Arbitrary caps (C) are safety mechanisms only. User response (D) is not relevant to agent completion. **Anti-pattern:** Parsing "I'm done" from text.
...
**Answer: B** | **Explanation:** This is the official stop_reason value when agent wants to execute a tool.
...
**Answer: C** | **Explanation:** Coordinator role is orchestration, not direct execution, storage, or monitoring.
...
**Answer: B** | **Explanation:** Subagents do not share context automatically. This prevents cross-contamination.
...
**Answer: C** | **Explanation:** The Task tool is specifically for spawning subagents in the Agent SDK.
...
**Answer: B** | **Explanation:** PostToolUse hooks execute AFTER tool call, BEFORE result returned to agent.
...
**Answer: B** | **Explanation:** Programmatic hooks are deterministic. Prompts are probabilistic and unsuitable for critical rules.
...
**Answer: B** | **Explanation:** This is the correct flag to resume a previous session.
...
**Answer: B** | **Explanation:** fork_session allows exploring alternatives without affecting main session.
...
**Answer: B** | **Explanation:** This is the optimal range for tool selection accuracy.
...
**Answer: B** | **Explanation:** Too many tools confuse the agent selection process.
...
**Answer: B** | **Explanation:** Prompt chaining uses a fixed sequence, unlike dynamic decomposition.
...
**Answer: B** | **Explanation:** Dynamic decomposition adapts based on intermediate results.
...
**Answer: B** | **Explanation:** This is unreliable compared to checking stop_reason.
...
**Answer: B** | **Explanation:** max_tokens indicates the response hit the token limit.
...
**Answer: D** | **Explanation:** This is not a valid stop_reason. Valid ones are: tool_use, end_turn, max_tokens, stop_sequence.
...
**Answer: B** | **Explanation:** Named sessions help manage multiple concurrent workflows.
...
**Answer: B** | **Explanation:** Long sessions accumulate context, leading to degradation.
...
**Answer: B** | **Explanation:** Scratchpad files store state that persists beyond context limits.
...
**Answer: B** | **Explanation:** /compact helps manage context bloat.
...
**Answer: B** | **Explanation:** In hub-and-spoke, the hub is the central coordinator.
...
**Answer: C** | **Explanation:** Spokes are the specialized agents that the hub coordinates.
...
**Answer: B** | **Explanation:** Agent can make multiple Task tool calls in one response for parallel execution.
...
**Answer: B** | **Explanation:** Overly narrow decomposition can miss important aspects.
...
**Answer: B** | **Explanation:** Coordinator should intelligently handle failures, not retry blindly or ignore.
...
**Answer: B** | **Explanation:** Critical business rules need programmatic enforcement.
...
**Answer: C** | **Explanation:** Soft guidelines are appropriate for prompt-based guidance.
...
**Answer: B** | **Explanation:** Hooks can block tool results and return errors instead.
...
**Answer: B** | **Explanation:** Hooks can modify results before returning to agent.
...
**Answer: B** | **Explanation:** Forking allows experimentation in isolation.
...
**Answer: B** | **Explanation:** Reset when context quality declines.
...
**Answer: B** | **Explanation:** Context window has limits; agent does not remember across sessions.
...
**Answer: B** | **Explanation:** Agent uses tool descriptions to select appropriate tools.
...
**Answer: B** | **Explanation:** This is the standard agentic loop pattern.
...
**Answer: B** | **Explanation:** Agents can use multiple tools sequentially within the loop.
...
**Answer: B** | **Explanation:** Context must be explicitly passed, not automatic.
...
**Answer: B** | **Explanation:** Isolation ensures agents do not interfere with each other.
...
**Answer: B** | **Explanation:** Coordinator aggregates and decides on next actions.
...
**Answer: A** | **Explanation:** Any agent with Task tool can spawn subagents.
...
**Answer: B** | **Explanation:** Partial success should be communicated with full context.
...
**Answer: B** | **Explanation:** Errors need context for proper handling.
...
**Answer: B** | **Explanation:** Caps are backup, stop_reason is primary.
...
**Answer: B** | **Explanation:** Text parsing is probabilistic; stop_reason is definitive.
...
**Answer: B** | **Explanation:** This is the programmatic signal to check.
...
**Answer: B** | **Explanation:** Use appropriate pattern based on task characteristics.
...
**Answer: D** | **Explanation:** Parallel processing with manageable chunks per subagent.
